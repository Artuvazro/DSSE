...
namespace DarthNemesis
{
    ...
    public sealed class CompressionManager
    {
        ...
        public const int PointerLength = 0x04;
        ...
        private static byte[] DecompressBinary(byte[] compressedData)
        {
            ...
            int compressedLengthPointer = compressedData.Length - (2 * PointerLength);
            ...
            int decompressedLengthPointer = compressedData.Length - PointerLength;
        ...
        {
            return (int)(Math.Ceiling((double)offset / PointerLength) * PointerLength);
        }
    }
}
